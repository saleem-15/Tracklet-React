          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={m.label} className="bg-slate-50/80 rounded-xl border border-slate-200/80 px-3.5 py-3 flex items-center gap-3 shadow-2xs hover:border-slate-300 transition-colors">
                ...
                <div className="min-w-0">
                  <span className="text-[11px] font-mono uppercase text-slate-500 font-semibold tracking-wider block">{m.label}</span>
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-[11px] font-mono transition-colors ${hasUnsavedNotes ? 'text-amber-600 font-semibold' : 'text-slate-500'}`}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button type="button" onClick={() => setShowAddEmail(!showAddEmail)} className="flex items-center gap-1 text-[11px] font-mono bg-white hover:bg-slate-50 text-slate-600 font-semibold px-2 py-1 rounded-lg border border-slate-200 shadow-2xs cursor-pointer transition-colors">
                      <Plus className="w-3 h-3" />
                      Log
                    </button>
                    {app.contactEmail && (
                      <a href={`mailto:${app.contactEmail}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-[11px] font-mono bg-blue-50 hover:bg-blue-100 text-blue-600 font-semibold px-2 py-1 rounded-lg border border-blue-200/60 shadow-2xs transition-colors">
                            ...
                            <div className="mt-2 pl-[42px] space-y-1.5">
                              {contact.phone && (
                                <div className="flex items-center justify-between text-[11px] text-slate-500 font-mono bg-slate-50 px-2.5 py-1.5 rounded-lg border border-slate-200/60 group/phone">
                                  ...
                                  <button type="button" onClick={() => handleCopyPhone(contact.phone!, contact.id)} className="opacity-0 group-hover/phone:opacity-100 transition-opacity flex items-center gap-1 text-[11px] text-blue-600 hover:text-blue-700 px-1.5 py-0.5 rounded cursor-pointer font-semibold">
                  ...
                  {isLoadingHistory ? (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] font-mono text-slate-500 mt-1">{formatTimestamp(app.createdAt || app.stageUpdatedAt)}</p>
                      </div>
                    </div>
                  ) : (
