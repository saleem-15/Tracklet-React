    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full pl-9 ${isPassword ? 'pr-10' : 'pr-3'} h-[38px] border rounded-xl text-xs text-slate-900 placeholder:text-slate-500 transition-all font-sans disabled:opacity-60 ${
            error
        ...
        {isPassword && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors cursor-pointer disabled:opacity-50"
          >
      ...
      {error && (
        <p
          id={errorId}
          role="alert"
          className="text-[11px] font-medium text-rose-600 flex items-center gap-1 pt-0.5 animate-in fade-in"
        >
