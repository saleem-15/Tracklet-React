      ...
      <div>
        ...
        <div className={`h-13 px-3 flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} border-b border-slate-200/80`}>
          ...
          <button
            ...
            className="relative p-1.5 rounded-lg text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 transition-colors cursor-pointer shrink-0 after:content-[''] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:min-w-[44px] after:min-h-[44px]"
          >
            {isCollapsed ? (
          ...
          <div className={`p-1.5 rounded-xl bg-white border border-slate-200/80 shadow-2xs flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} gap-2`}>
            ...
            {!isCollapsed && (
              <button
                onClick={onSignOut}
                title="Sign out"
                className="relative text-slate-400 hover:text-slate-700 p-1 rounded-md hover:bg-slate-100 transition-colors cursor-pointer after:content-[''] after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:min-w-[44px] after:min-h-[44px]"
              >
